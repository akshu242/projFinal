...
import { ShowPolByCidComponent } from './show-pol-by-cid/show-pol-by-cid.component';
import { AddCustAdddressComponent } from './add-cust-adddress/add-cust-adddress.component';
import { AddCustHealthComponent } from './add-cust-health/add-cust-health.component';
@NgModule({
  declarations: [
    AppComponent,
    HomeComponent,
    ...
    ViewPlansComponent,
    ShowPolByCidComponent,
    AddCustAdddressComponent,
    AddCustHealthComponent
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
